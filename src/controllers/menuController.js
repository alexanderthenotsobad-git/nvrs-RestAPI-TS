...
var getAllMenuItems = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var items, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, menuItemService.getAllMenuItems()];
            case 1:
                items = _a.sent();
                res.json(items);
                return [3 /*break*/, 3];
...
var createMenuItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newItemId, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, menuItemService.createMenuItem(req.body)];
            case 1:
                newItemId = _a.sent();
...
var deleteMenuItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var item_name, affectedRows, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                item_name = req.body.item_name;
                return [4 /*yield*/, menuItemService.deleteMenuItem(item_name)];
            case 1:
